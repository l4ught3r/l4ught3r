...
<style>
.icon-row { display:flex; gap:12px; justify-content:center; align-items:center; flex-wrap:wrap; margin:12px 0; }
.icon-row svg, .icon-row img { width:36px; height:36px; display:block; }
</style>
